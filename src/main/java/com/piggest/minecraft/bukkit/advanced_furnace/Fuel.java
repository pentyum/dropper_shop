...
public enum Fuel {
	coal(2, Status.solid, 1600), charcoal(1.45, Status.solid, 1600), coal_block(1.9, Status.solid, 16000),
	...
	carpet(1.1, Status.solid, 67), planks(1.4, Status.solid, 300), wheat_powder(9, Status.solid, 40),
