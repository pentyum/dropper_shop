...
public enum Fuel {
	...
	blaze_rod(2.2, Status.solid, 2400), sugar(1.05, Status.solid, 300), coal_powder(2.5, Status.solid, 1600),
	lava(1.6, Status.liquid, 20), gun_powder(12, Status.solid, 40), wool(1.0, Status.solid, 100),
	carpet(1.0, Status.solid, 67), planks(1.38, Status.solid, 300), wheat_powder(9, Status.solid, 40),
