...
public enum Fuel {
	coal(1.95, Status.solid, 1600), charcoal(1.3, Status.solid, 1600), coal_block(1.9, Status.solid, 16000),
	...
	carpet(1.0, Status.solid, 67), planks(1.25, Status.solid, 300), wheat_powder(9, Status.solid, 40),
	stick(2.0, Status.solid, 100), hydrogen(2.5, Status.gas, 4), CO(1.9, Status.gas, 4), CH4(2.6, Status.gas, 4),
