...
public enum Fuel {
	...
	blaze_rod(2.2, Status.solid, 2400), suger(1.1, Status.solid, 300), coal_powder(2.75, Status.solid, 1600),
	lava_bucket(1.7, Status.liquid, 20000), gun_powder(9, Status.solid, 80), wool(1.2, Status.solid, 100),
	carpet(1.2, Status.solid, 67),planks(1.4, Status.solid, 300);
