...
public class Teleport_machine_manager extends Gui_structure_manager<Teleport_machine> {
	...
	private Material[][][] model = new Material[][][] {
		{{Material.QUARTZ_PILLAR,Material.SMOOTH_QUARTZ,Material.SMOOTH_QUARTZ,Material.SMOOTH_QUARTZ,Material.QUARTZ_PILLAR},
			{Material.SMOOTH_QUARTZ,Material.CHISELED_QUARTZ_BLOCK,Material.SMOOTH_QUARTZ,Material.CHISELED_QUARTZ_BLOCK,Material.SMOOTH_QUARTZ},
			{Material.SMOOTH_QUARTZ,Material.SMOOTH_QUARTZ,Material.SEA_LANTERN,Material.SMOOTH_QUARTZ,Material.SMOOTH_QUARTZ},
			{Material.SMOOTH_QUARTZ,Material.CHISELED_QUARTZ_BLOCK,Material.SMOOTH_QUARTZ,Material.CHISELED_QUARTZ_BLOCK,Material.SMOOTH_QUARTZ},
			{Material.QUARTZ_PILLAR,Material.SMOOTH_QUARTZ,Material.SMOOTH_QUARTZ,Material.SMOOTH_QUARTZ,Material.QUARTZ_PILLAR}},
		{{Material.QUARTZ_PILLAR,Material.QUARTZ_STAIRS,Material.QUARTZ_STAIRS,Material.QUARTZ_STAIRS,Material.QUARTZ_PILLAR},
	...
	public Teleport_machine_manager() {
		...
		this.set_gui(30, Material.END_ROD, "§r天线信息", Gui_slot_type.Indicator);
