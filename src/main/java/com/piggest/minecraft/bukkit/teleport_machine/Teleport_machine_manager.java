...
public class Teleport_machine_manager extends Gui_structure_manager<Teleport_machine> {
	...
	public Teleport_machine_manager() {
		...
		this.set_gui(27, Material.LEVER, "§r无线魔术开关", Gui_slot_type.Switch);
		...
		this.set_gui(Teleport_machine.radio_indicator, Material.END_ROD, "§r当前无线魔术信息",
				new String[] { "§7终端名称: 魔术传送台", "§7运行状态: " + Radio_state.OFF.display_name, "§7当前输入功率: 0W",
						"§7当前辐射功率: 0W", "§7天线长度: 1m", "§7中心频率: kHz", "§7天线频宽: kHz", "§7天线魔阻: Ω", "§7天线魔抗: Ω" },
		...
		this.set_gui(Teleport_machine.magic_indicator, Material.EXPERIENCE_BOTTLE, "§r魔力信息",
				new String[] { "§7剩余: 0单位" }, Gui_slot_type.Indicator);
		...
		this.set_gui(32, Material.RED_STAINED_GLASS_PANE, "§r提高待机魔压", Gui_slot_type.Button);
		this.set_gui(33, Material.RED_STAINED_GLASS_PANE, "§r提高发射魔压", Gui_slot_type.Button);
		...
		this.set_gui(Teleport_machine.online_voltage_indicator, Material.COMPASS, "§r当前待机魔压", new String[] { "§7 0 V" },
				Gui_slot_type.Indicator);
		this.set_gui(Teleport_machine.working_voltage_indicator, Material.COMPASS, "§r当前发射魔压",
		...
		this.set_gui(50, Material.BLUE_STAINED_GLASS_PANE, "§r降低待机魔压", Gui_slot_type.Button);
		this.set_gui(51, Material.BLUE_STAINED_GLASS_PANE, "§r降低发射魔压", Gui_slot_type.Button);
