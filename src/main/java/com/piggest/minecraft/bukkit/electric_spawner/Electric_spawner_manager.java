...
public class Electric_spawner_manager extends Gui_structure_manager<Electric_spawner> {
	...
	public Electric_spawner_manager() {
		...
		this.set_gui(Electric_spawner.look_button_slot, Material.ENCHANTED_BOOK, "§e查看召唤概率", Gui_slot_type.Button);
		this.set_gui(Electric_spawner.info_indicator_slot, Material.SPAWNER, "§e刷怪信息", Gui_slot_type.Indicator);
		this.set_gui(Electric_spawner.synthesis_button_slot, Material.CRAFTING_TABLE, "§e合成", Gui_slot_type.Button);
	...
	private void init_recipe() {
		...
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.ZOMBIE, 3),
				new Entity_probability(EntityType.ZOMBIE_VILLAGER, 1),
				new Entity_probability(EntityType.HUSK, 1),
				new Entity_probability(EntityType.PIG_ZOMBIE, 1),
				new Entity_probability(EntityType.DROWNED, 1)};
		this.probability_map.put(Material.ROTTEN_FLESH.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.SKELETON, 3),
				new Entity_probability(EntityType.SKELETON_HORSE, 1),
				new Entity_probability(EntityType.STRAY, 1)};
		this.probability_map.put(Material.BONE.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.SKELETON, 1)};
		this.probability_map.put(Material.BONE_MEAL.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.SKELETON_HORSE, 2),
				new Entity_probability(EntityType.STRAY, 1)};
		this.probability_map.put(Material.BONE_BLOCK.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.SKELETON, 2),
				new Entity_probability(EntityType.STRAY, 1),
				new Entity_probability(EntityType.PILLAGER, 1)};
		this.probability_map.put(Material.ARROW.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.SKELETON, 20),
				new Entity_probability(EntityType.STRAY, 20)};
		this.probability_map.put(Material.BOW.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.PILLAGER, 30)};
		this.probability_map.put(Material.CROSSBOW.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.SPIDER, 2),
		...
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.SPIDER, 1),
				new Entity_probability(EntityType.CAVE_SPIDER, 1),
				new Entity_probability(EntityType.CAT, 1)};
		this.probability_map.put(Material.STRING.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.ENDERMAN, 2),
		...
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.SLIME, 2)};
		...
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.BLAZE, 2)};
		this.probability_map.put(Material.BLAZE_ROD.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.GUARDIAN, 1)};
		...
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.PHANTOM, 2)};
		this.probability_map.put(Material.PHANTOM_MEMBRANE.getKey().toString(), probability_list);
		
		probability_list = new Entity_probability[] { 
				new Entity_probability(EntityType.VINDICATOR, 2)};
